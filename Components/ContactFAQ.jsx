...
const faqData = [
  ...
  },
  {
    ...
    answer:
      "Vasudhara's animal care centres and advanced wildlife hospitals are located in Jamnagar, Gujarat. While based in India, Vasudhara rescues and provides care for animals from around the world, offering a safe haven for those in need of treatment, lifelong care and rehabilitation.",
  },
  {
...
const FAQ = () => {
  ...
  return (
    <div ref={containerRef} className="bg-gradient-to-b from-white/5 to-green-500/10 py-20 px-6">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="space-y-6">
          {faqData.map((item, index) => (
            <div key={index} className="faq-item border-t border-gray-300 pt-6">
              <div
