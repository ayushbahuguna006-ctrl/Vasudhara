        ...
        <div className='flex flex-col items-center max-w-7xl mx-auto md:flex-row justify-between gap-4'>
            <div className='flex flex-col items-center gap-8'>
                <div className='flex items-center gap-6 lg:gap-15'>
                    <img src="/public/logo1.png" alt="" className='h-10 md:h-20 ' />
                    <img src="/public/logo2.png" alt="" className='h-10 md:h-20' />
                    <img src="/public/logo3.svg" alt="" className='h-10 md:h-20' />
                    <img src="/public/logo4.svg" alt="" className='h-10 md:h-20' />
                </div>
